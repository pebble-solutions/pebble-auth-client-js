...
function auth(token) {
    return __awaiter(this, void 0, void 0, function* () {
        const JWKS = (0, jose_1.createLocalJWKSet)((0, key_1.getJWKSet)());
        const { payload, protectedHeader } = yield (0, jose_1.jwtVerify)(token, JWKS);
 ...
 */
function authFromHttpHeaders() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield auth("http_provided_token");
    });
}
